...
<section id="contact" className="contact">
  <div className="container">
    ...
    <a href="https://drive.google.com/file/d/1WdnUJFJ7j3Ny0_n84lLAbas-YXlqU-kD/view?usp=sharing" className="file-pdf" target="blank"><i className='bx bxs-file-pdf'></i></a></h2>
  </div>
