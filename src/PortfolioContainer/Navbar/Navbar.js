    ...
    <div className="d-flex flex-column">
      ...
      <div className="profile">
        ...
        <div className="social-links mt-3 text-center">
          ...
          <a href="https://drive.google.com/file/d/1SnuqZ4Qr0x71taFBEo0pTfkReLjCozvD/view?usp=sharing" className="file-pdf" target="blank"><i className='bx bxs-file-pdf' ></i></a>
        </div>
      </div>
